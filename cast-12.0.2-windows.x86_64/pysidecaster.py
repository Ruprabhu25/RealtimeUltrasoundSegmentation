...
dll_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "cast.dll"))
ctypes.CDLL(dll_path)

# Make sure Python sees the pyclariuscast.pyd
pyd_dir = os.path.join(os.path.dirname(__file__), "python39")
...
class MainWidget(QtWidgets.QMainWindow):
    ...
    def shutdown(self):
        ...
        self.cast.destroy() 
        quaternions.to_csv(f"/home/satvi/RealtimeUltrasoundSegmentation/cast-12.0.2-linux.x86_64-gcc_ubuntu_20.04/positions/quaternion_run_{time_run}.csv", columns=["qw", "qx", "qy", "qz"], index=False)
